...
/**
 * This Direction class determines all aspects of the robots direction, including which way the robot should
 * go next should it collide with another robot or the arena wall.
 */
...
public class Direction {
     ...
     * 16 point compass) directions that the robot can take.
     */
